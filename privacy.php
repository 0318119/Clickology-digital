...
<body class="home-page">
    <header>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-3">
                    <a href="index.php" class="header-logo logo-img ">
                        <img src="assets/images/clickology.png" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="col-md-9">
                    <div class="phoneInfo">
                        <ul>
                            ...
                            <li>
                                <a href="tel:+1(888)-808-1288"><i class="tell-icon for-sprite"></i> Call 24/7:<span>+1(888)-808-1288</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 privacy">
                    <div class="term-text">
                        ...
                        <p>At Clickology the protection of our customers is our top need on https://digitlogodesign.com and
                        ...
                        <p>The data gathered by Clickology incorporates the customer’s name, email, postage information
                        ...
                        <p>In the event that you have any inquiries concerning security on our Web website, you can send
                            email us at example@gmail.com</p>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; Copyright 2021 Clickology. All Rights Reserved</p>
                </div>
                <div class="col-md-6">
                    <p class="text-right">
